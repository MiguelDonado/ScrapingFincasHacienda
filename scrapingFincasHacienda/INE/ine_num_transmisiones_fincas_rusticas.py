...
class IneNumTransmisionesFincasRusticas(webdriver.Chrome):
    ...
    def choose_province(self, cp_two_digits_province):
        ...
        province_name_option = self.find_element(
            By.XPATH,
            f"//option[@class='jP_2' and contains(text(), '{cp_two_digits_province}')]",
        )
    ...
    def get_results(self):
        ...
        return {
            "value_actual_year": value_actual_year,
            "value_seven_years_ago": value_seven_years_ago,
            "variation": variation,
        }
